...
public class ButtonOnClickListener implements OnClickListener {
	...
	private static ButtonOnClickListener thisInstance;
	private EditText titleView;
	private EditText contentView;
	private Button save;
	private Button cancel;
	
	public static ButtonOnClickListener getInstance(EditText titleView,
			EditText contentView,
			Button save,
			Button cancel) {
		if (thisInstance == null) {
			thisInstance = new ButtonOnClickListener();
		}
